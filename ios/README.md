...
- 六个模式都能切换，并显示对应的上下文/草稿提示。
- 点击“粘贴上下文”能把剪贴板文本填入上下文输入框。
- 点击“OCR 导入”能从用户选择的图片识别文字，并填入上下文输入框。
- 成功生成后，底部“历史”Tab 能看到本次生成记录。
- 历史记录里能看到模式、语言、上下文摘要、3 条候选和 request_id。
- 历史记录里的候选可以复制。
- 点击历史页右上角“清理”后，历史记录清空。
